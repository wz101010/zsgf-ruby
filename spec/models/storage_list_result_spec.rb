...
# Unit tests for ZSGFClient::StorageListResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ZSGFClient::StorageListResult do
  let(:instance) { ZSGFClient::StorageListResult.new }

  describe 'test an instance of StorageListResult' do
    it 'should create an instance of StorageListResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ZSGFClient::StorageListResult)
    end
  end
