...
# Unit tests for ZSGFClient::ServiceProvider
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ZSGFClient::ServiceProvider do
  let(:instance) { ZSGFClient::ServiceProvider.new }

  describe 'test an instance of ServiceProvider' do
    it 'should create an instance of ServiceProvider' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ZSGFClient::ServiceProvider)
    end
  end
