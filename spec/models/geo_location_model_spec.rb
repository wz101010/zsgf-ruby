...
# Unit tests for ZSGFClient::GeoLocationModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ZSGFClient::GeoLocationModel do
  let(:instance) { ZSGFClient::GeoLocationModel.new }

  describe 'test an instance of GeoLocationModel' do
    it 'should create an instance of GeoLocationModel' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ZSGFClient::GeoLocationModel)
    end
  end
