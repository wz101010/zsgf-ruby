...
app_key = 'app_key_example' # String | 
opts = {
  body: 3.56 # Object | scheme码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/OpenApiDoc/qrcode-link/url-scheme/generateScheme.html
}
...
app_key = 'app_key_example' # String | 
opts = {
  body: 3.56 # Object | 订阅消息数据，开发参考：https://dwz.cn/IXptek5n
}
...
app_key = 'app_key_example' # String | 
opts = {
  body: 3.56 # Object | 订阅消息数据，开发参考：https://dwz.cn/bohXaCnp
}
...
app_key = 'app_key_example' # String | 
opts = {
  body: 3.56 # Object | 跳转地址数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/url-link/urllink.generate.html
}
...
app_key = 'app_key_example' # String | 
opts = {
  body: 3.56 # Object | 小程序码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/qr-code/wxacode.get.html
}
...
app_key = 'app_key_example' # String | 
opts = {
  body: 3.56 # Object | 小程序码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/qr-code/wxacode.getUnlimited.html
}
