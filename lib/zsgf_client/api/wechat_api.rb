...
module ZSGFClient
  class WechatApi
    ...
    # @param app_key [String] 
    # @param [Hash] opts the optional parameters
    # @option opts [Object] :body scheme码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/OpenApiDoc/qrcode-link/url-scheme/generateScheme.html
    # @return [StringApiResponse]
    ...
    # @param app_key [String] 
    # @param [Hash] opts the optional parameters
    # @option opts [Object] :body 订阅消息数据，开发参考：https://dwz.cn/IXptek5n
    # @return [StringApiResponse]
    ...
    # @param app_key [String] 
    # @param [Hash] opts the optional parameters
    # @option opts [Object] :body 订阅消息数据，开发参考：https://dwz.cn/bohXaCnp
    # @return [StringApiResponse]
    ...
    # @param app_key [String] 
    # @param [Hash] opts the optional parameters
    # @option opts [Object] :body 跳转地址数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/url-link/urllink.generate.html
    # @return [StringApiResponse]
    ...
    # @param app_key [String] 
    # @param [Hash] opts the optional parameters
    # @option opts [Object] :body 小程序码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/qr-code/wxacode.get.html
    # @return [File]
    ...
    def wechat_wxa_code_get_with_http_info(app_key, opts = {})
      ...
      header_params = opts[:header_params] || {}
      # HTTP header 'Accept' (if needed)
      header_params['Accept'] = @api_client.select_header_accept(['image/jpeg', 'text/plain']) unless header_params['Accept']
      # HTTP header 'Content-Type'
      content_type = @api_client.select_header_content_type(['application/json-patch+json', 'application/json', 'text/json', 'application/*+json'])
      if !content_type.nil?
          header_params['Content-Type'] = content_type
    ...
    # @param app_key [String] 
    # @param [Hash] opts the optional parameters
    # @option opts [Object] :body 小程序码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/qr-code/wxacode.getUnlimited.html
    # @return [File]
