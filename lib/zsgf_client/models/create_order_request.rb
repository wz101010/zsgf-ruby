  ...
  class CreateOrderRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ZSGFClient::CreateOrderRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ZSGFClient::CreateOrderRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @product_type.to_s.length < 1
        invalid_properties.push('invalid value for "product_type", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @product_name.to_s.length < 1
      return false if @product_type.nil?
      return false if @product_type.to_s.length < 1
      return false if @product_id.nil?
      return false if @product_id.to_s.length < 1
      true
    end
    ...
    def product_type=(product_type)
      ...
      if product_type.to_s.length < 1
        fail ArgumentError, 'invalid value for "product_type", the character length must be great than or equal to 1.'
      end
    ...
    def hash
      [amount, product_name, product_type, product_id].hash
    end
