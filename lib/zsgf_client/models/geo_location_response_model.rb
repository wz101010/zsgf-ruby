...
module ZSGFClient
  class GeoLocationResponseModel
    ...
    def hash
      [latitude, longitude, location_name, location_type, recipient_name, phone_number, email, country, state, city, district, street, zip_code, address, map_type, remark, tags, enable, show_index, create_date, last_update, id].hash
    end
